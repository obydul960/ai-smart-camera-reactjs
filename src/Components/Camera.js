...
// sweet alert popup message show compermation
  ...
  async function ageAndGenderDetection(){
      ...
      const ageAndGender  = await faceapi.detectAllFaces(images).withAgeAndGender();
      setAgeAndGender(ageAndGender);
      ...
      <Fragment>
        ...
        <Container>
          <Row>
            ...
            <h2>Face Landmrk</h2> 
            <button onClick={ageAndGenderDetection} className="btn mt-3 btn-lg btn-primary">
                Get Age & Gender
              </button>
